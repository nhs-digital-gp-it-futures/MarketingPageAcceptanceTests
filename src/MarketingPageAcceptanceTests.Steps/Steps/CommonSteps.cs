...
namespace MarketingPageAcceptanceTests.Steps.Steps
{
    ...
    public sealed class CommonSteps : TestBase
    {
        ...
        [Given(@"a (Roadmap|NHS Assured Integrations) attachment has been provided for the Solution")]
        public async Task GivenARoadmapAttachmentHasBeenProvidedForTheSolution(string documentType)
        {
            string fileName;
