...
Scenario: Solution Description - Field does not exceed maximum
...
Scenario: Solution Description - Field does exceed maximum
	Given the Supplier has entered data into any field
...
Scenario: Solution Description - Marked as Incomplete Mandatory Data Missing
...
Scenario: Solution Description - Marked as Complete
	Given the Supplier has entered data into any field
	And it does not exceed the maximum
	When the Supplier attempts to save
...
Scenario: Solution Description - No Summary
