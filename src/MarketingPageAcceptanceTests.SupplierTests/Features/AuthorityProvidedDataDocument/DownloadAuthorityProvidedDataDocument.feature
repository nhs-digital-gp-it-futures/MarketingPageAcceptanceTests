...
Scenario: Download Authority Provided Data Document - Download Attachment
	Given an Authority Provided Data Document attachment has been provided for the Solution
...
Scenario: Download Authority Provided Data Document - Section not shown
	Given a Authority Provided Data Document attachment has not been provided for the Solution
