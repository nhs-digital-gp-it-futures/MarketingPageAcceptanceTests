...
Scenario: Native Desktop Memory, Storage, Processing and Resolution - Mandatory - Yes
	Given that Memory, storage, processing and resolution has been completed for Native desktop
	And has navigated to the Native desktop Client Application Sub-Form
	Then the Memory, storage, processing and resolution Sub-Section is marked as Complete
...
Scenario: Native Desktop Memory, Storage, Processing and Resolution - Mandatory - No
	...
	Then the Memory, storage, processing and resolution Sub-Section is marked as Incomplete 

Scenario: Native Desktop Memory, Storage, Processing and Resolution - Does not exceed maximum
	Given that Memory, storage, processing and resolution has been completed for Native desktop with 300 characters
	When the User attempts to save 
	Then the Memory, storage, processing and resolution is saved

Scenario: Native Desktop Memory, Storage, Processing and Resolution - Does exceed maximum
	Given that Memory, storage, processing and resolution has been completed for Native desktop with 301 characters	
	When the User attempts to save 
	Then the Section is not saved 
	And an indication is given to the Supplier as to why

Scenario: Native Desktop Memory, Storage, Processing and Resolution - Validation on Save
	Given validation has been triggered on Native desktop section Memory, storage, processing and resolution
	When the User attempts to save
	Then the Section is not saved 
	And an indication is given to the Supplier as to why
