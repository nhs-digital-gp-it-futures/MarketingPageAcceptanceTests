...
Scenario: Native Desktop Third Party Components And Device Capabilities - Does not exceed maximum
...
Scenario: Native Desktop Third Party Components And Device Capabilities - Does exceed maximum
...
Scenario: Native Desktop Third Party Components And Device Capabilities - Native Desktop Application Type Sub-Section marked as Incomplete - No Mandatory Data Required
...
Scenario: Native Desktop Third Party Components And Device Capabilities - Native Desktop Application Type Sub-Section marked as Complete - No Mandatory Data Required
