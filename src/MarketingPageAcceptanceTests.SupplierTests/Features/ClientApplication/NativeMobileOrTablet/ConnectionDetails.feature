...
Scenario: Native Mobile Connection Details - Does not exceed maximum
...
Scenario: Native Mobile Connection Details - Does exceed maximum
...
Scenario: Native Mobile Connection Details - Native Mobile or Tablet Application Type Sub-Section marked as Incomplete - No Mandatory Data Required
...
Scenario: Native Mobile Connection Details - Native Mobile or Tablet Application Type Sub-Section marked as Complete - No Mandatory Data Required
	Given the Connection details Sub-Section in the Native mobile or tablet section does not require Mandatory Data
