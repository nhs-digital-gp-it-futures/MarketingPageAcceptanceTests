...
Scenario Outline: Native Mobile Hardware and Additional Information - Does not exceed maximum
...
Scenario Outline: Native Mobile Hardware and Additional Information - Does exceed maximum
	Given the Supplier has entered <MaxChars> characters on the <PageTitle> page in the Native mobile or tablet section
	When the Supplier attempts to save 
...
Scenario Outline: Native Mobile Hardware and Additional Information - Sub-Section marked as Incomplete - No Mandatory Data Required + no data
...
Scenario Outline: Native Mobile Hardware and Additional Information - Sub-Section marked as Complete - No Mandatory Data Required + data present
	Given the <PageTitle> Sub-Section in the Native mobile or tablet section does not require Mandatory Data
