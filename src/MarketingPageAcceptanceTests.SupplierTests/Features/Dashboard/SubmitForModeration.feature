...
Scenario: Submit for Moderation - Mandatory Data Present - Submit
...
Scenario: Submit for Moderation - Mandatory Data Missing - Submit
...
Scenario: Submit for Moderation - Validation Error Message Anchors
