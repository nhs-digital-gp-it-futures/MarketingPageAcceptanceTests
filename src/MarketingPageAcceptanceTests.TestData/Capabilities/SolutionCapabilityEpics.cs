...
namespace MarketingPageAcceptanceTests.TestData.Capabilities
{
    ...
    {
        [Display(Name = "Supplier ID")] public string SupplierID { get; set; }
        [Display(Name = "Solution ID")] public string SolutionID { get; set; }
        ...
        [Display(Name = "Epic ID")] public string EpicID { get; set; }
