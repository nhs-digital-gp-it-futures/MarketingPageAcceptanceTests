namespace MarketingPageAcceptanceTests.TestData.Utils
{
    internal static class Queries
    {
        ...
        internal const string CreateSolutionDetail = "INSERT INTO SolutionDetail (Id, SolutionId, LastUpdatedBy, LastUpdated) values (@solutionDetailId, @solutionId, @lastUpdatedBy, @lastUpdated)";
