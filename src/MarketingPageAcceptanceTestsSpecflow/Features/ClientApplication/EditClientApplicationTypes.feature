...
Scenario Outline: Client Application Type - Client Application Type Selected
...
Scenario: Client Application Type - Client Application Type Not Selected
...
Scenario: Client Application Type - Client Application Type Section marked as Incomplete -  Mandatory Data Missing
...
Scenario:  Client Application Type - Client Application Type Section marked as Complete -  Mandatory Data Present
	Given the Client Application Type Section requires Mandatory Data
...
Scenario: Client Application Type - Validation on Submission
