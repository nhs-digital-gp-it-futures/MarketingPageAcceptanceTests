...
Scenario: Native desktop Connection Details - Mandatory - Yes
...
Scenario: Native desktop Connection Details - Mandatory - No
...
Scenario: Native desktop Connection Details - Validation on Save
