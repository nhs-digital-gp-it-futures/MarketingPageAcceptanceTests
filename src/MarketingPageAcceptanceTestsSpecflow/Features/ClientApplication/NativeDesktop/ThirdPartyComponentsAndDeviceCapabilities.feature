...
Scenario: Appear on Preview
	Given the Supplier has entered 200 characters on the Third party components and device capabilities page in the Native desktop section
	And I enter 200 characters into the second text field
	And the user has saved the data 
	When a User previews the Marketing Page
	Then Third party components required will be presented in Native desktop on the Preview of the Marketing Page
	And Device capabilities required will be presented in Native desktop on the Preview of the Marketing Page
