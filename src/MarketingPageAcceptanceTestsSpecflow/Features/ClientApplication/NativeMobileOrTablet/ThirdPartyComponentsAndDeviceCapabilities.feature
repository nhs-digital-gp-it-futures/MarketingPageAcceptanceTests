...
Scenario: Native Mobile Third Party Components And Device Capabilities - Native Mobile or Tablet Application Type Sub-Section marked as Incomplete - No Mandatory Data Required
