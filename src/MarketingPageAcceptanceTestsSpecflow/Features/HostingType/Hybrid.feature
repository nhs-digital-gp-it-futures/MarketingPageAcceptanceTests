...
Scenario: Hybrid Hosting Type - Field does not exceed maximum
	Given the Supplier has entered 500 characters on the Hybrid hosting page in the Hybrid section
...
Scenario: Hybrid Hosting Type - Field does exceed maximum
	Given the Supplier has entered 501 characters on the Hybrid hosting page in the Hybrid section
...
Scenario: Hybrid Hosting Type - Hosting Section marked as Complete -  Any Data Saved
...
Scenario: Hybrid Hosting Type - Hosting Type Section marked as Incomplete -  No Data
	Given the Hybrid section does not require Mandatory Data
	And a User has not saved any data on the Hybrid section
	When the Marketing Page Form is presented 
	Then the Hybrid section is marked as Incomplete

Scenario: Hybrid Hosting Type - HSCN/N3 connection does not appear on preview when not checked
