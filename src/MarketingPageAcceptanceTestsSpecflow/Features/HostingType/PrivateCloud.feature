...
Scenario: Private Cloud Hosting Type - Field does not exceed maximum
	Given the Supplier has entered 500 characters on the Private cloud hosting page in the Private cloud section
...
Scenario: Private Cloud Hosting Type - Field does exceed maximum
	Given the Supplier has entered 501 characters on the Private cloud hosting page in the Private cloud section
...
Scenario: Private Cloud Hosting Type - Hosting Section marked as Complete -  Any Data Saved
...
Scenario: Private Cloud Hosting Type - Hosting Type Section marked as Incomplete -  No Data
	Given the Private cloud section does not require Mandatory Data
	And a User has not saved any data on the Private cloud section
	When the Marketing Page Form is presented 
	Then the Private cloud section is marked as Incomplete

Scenario: Private Cloud Hosting Type - HSCN/N3 connection does not appear on preview when not checked
